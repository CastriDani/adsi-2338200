...
function bloquearTarjetas(){
    for (let i = 0; i <= 15; i++) {
        ...
        tarjetaBloqueada.innerHTML = `<img src="../images/Challenge-Time/poker/${numeros[i]}.svg" >`;
...
function destapar(id) {
    ...
    if(tarjetasDestapadas == 1){
        ...
        tarjeta1.innerHTML = `<img src="../images/Challenge-Time/poker/${primerResultado}.svg" >`;
        clickAudio.play();
        ...
        tarjeta2.innerHTML = `<img src="../images/Challenge-Time/poker/${segundoResultado}.svg" >`;
        //desactivar 2 boton
